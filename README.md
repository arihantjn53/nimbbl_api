...
6. Open your browser and go to `http://localhost:8888` to see the app running.
...
7. Since there is only one SQLAlchemy model, you can create a new migration file by running the following command:
   ...
   This will create a new migration file in `nimbbl_api/alembic/versions/`.
...
8. To check the documentation of the API, go to `http://localhost:8888/docs`.
